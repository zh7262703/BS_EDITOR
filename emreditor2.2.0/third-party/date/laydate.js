...
;!function(){
    ...
    */
    ...
    Class.prototype.config = {
      ...
      ,theme: 'default' //主题
      ,position: 'absolute' //控件定位方式定位, 默认absolute，支持：fixed/absolute/static
    ...
    Class.prototype.position = function(){
      ...
      ,containerLeft = WO.editor.container.offsetLeft
      //滚动条高度
      ...
      that.elem.style.left = containerLeft + left + (options.position === 'fixed' ? 0 : scrollArea(1)) + 'px';
