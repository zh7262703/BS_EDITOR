 ...
 * build: Thu May 31 2018 16:19:16 GMT+0800 (China Standard Time)
 */
!
    function() { !
        function() {
                ...
                b = {
                    ...
                    on: function(a, c, d) {
                        var e = this.isArray(c) ? c: c.split(/\s+/),
                            f = e.length;
                        if (f) for (; f--;) if (c = e[f], a.addEventListener) a.addEventListener(c, d, !1);
                        else {
                            d._d || (d._d = {
                                els: []
                            });
                    ...
                    off: function(a, c, d) {
                        var e = this.isArray(c) ? c: c.split(/\s+/),
                            f = e.length;
                        if (f) for (; f--;) if (c = e[f], a.removeEventListener) a.removeEventListener(c, d, !1);
                        else {
                            var g = c + d.toString();
                            try {
            ...
            b.each(["String", "Function", "Array", "Number", "RegExp", "Object", "Boolean"],
                function(a) {
                    b["is" + a] = function(b) {
                ...
                uParse = function(a, c) {
                    b.domReady(function() {
                        ...
                        if (document.querySelectorAll) d = document.querySelectorAll(a);
                            ...
                            var d = [];
                            b.each(document.getElementsByTagName("*"),
                                function(b) {
        ...
        UE.parse.register("table",
            function(a) {
                ...
                if (h.length) {
                    ...
                    a.each(h,
                        function(d) { / \bsortEnabled\b / .test(d.className) && a.on(d, "click",
                            function(d) {
        ...
        UE.parse.register("charts",
            function(a) {
                ...
                function d(a) {
                    for (var b, c = a.getAttribute("data-chart"), d = {},
                             e = [], f = 0; b = a.rows[f]; f++) {
                    ...
                    c = c.split(";");
                    for (var k, f = 0; k = c[f]; f++) k = k.split(":"),
                        d[k[0]] = k[1];
                    return {
                        table: a,
                        meta: d,
                ...
                function k(a) {
                    ...
                    return b.className = "edui-chart-container",
                ...
                function l(a) {
                    ...
                    if (d = {},
                    f.chartType != typeConfig.length - 1) {
                        c = e[0].slice(1);
        ...
        UE.parse.register("list",
            function(a) {
                        ...
                        function(b) {
                            if (b.className && /custom_/i.test(b.className)) {
                                ...
                                if ("dash" == f || "dot" == f) a.pushItem(c, h + " li.list-" + d[f] + "{background-image:url(" + e.liiconpath + d[f] + ".gif)}"),
                                    a.pushItem(c, h + " ul.custom_" + f + "{list-style:none;} " + h + " ul.custom_" + f + " li{background-position:0 3px;background-repeat:no-repeat}");
                                else {
                                    var g = 1;
                                    a.each(b.childNodes,
                                        function(b) {
                ...
                (f.length || g.length) && (c.push(h + " .list-paddingleft-1{padding-left:0}"), c.push(h + " .list-paddingleft-2{padding-left:" + this.listDefaultPaddingLeft + "px}"), c.push(h + " .list-paddingleft-3{padding-left:" + 2 * this.listDefaultPaddingLeft + "px}"), a.cssRule("list", h + " ol," + h + " ul{margin:0;padding:0;}\n" + h + " li{clear:both;}\n" + c.join("\n"), document))
            }),
