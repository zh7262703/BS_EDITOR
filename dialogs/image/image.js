...
(function () {
    ...
    function initButtons() {
        ...
        dialog.onok = function () {
            ...
            if(list) {
                var dcm = $G('dcmurl').value;
                editor.execCommand('insertimage', list,dcm);
    ...
    RemoteImage.prototype = {
        ...
        setImage: function(img){
            ...
            if(src) {
                /* 设置表单内容 */
                $G("id").value = img.getAttribute("data-id") || '';
                $G("textreadonly").checked = img.getAttribute("isreadonly") == 1 ?true:false;
